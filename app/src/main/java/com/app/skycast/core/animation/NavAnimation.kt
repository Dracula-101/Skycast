...
import com.app.skycast.presentation.screen.app.rootLevelRoute
    ...
    object Enter {
        ...
        val pushLeft: NonNullEnterTransitionProvider = {
            ...
            slideInHorizontally(
                ...
                animationSpec = tween(
                    durationMillis = totalTransitionDurationMs / 4,
                    delayMillis = totalTransitionDurationMs / 4,
                ),
            )
        }
...
fun AnimatedContentTransitionScope<NavBackStackEntry>.toEnterTransition(): NonNullEnterTransitionProvider =
    when (targetState.destination.rootLevelRoute()?.toAppRoute()) {
        AppRoute.SelectCityGraph -> RootTransitionProviders.Enter.pushLeft
        AppRoute.SelectCityGraph.SelectLocationIntro -> RootTransitionProviders.Enter.pushLeft
        AppRoute.SelectCityGraph.CityLocator -> RootTransitionProviders.Enter.slideUp
        AppRoute.Splash -> RootTransitionProviders.Enter.stay
        AppRoute.HomeGraph -> RootTransitionProviders.Enter.pushLeft
        AppRoute.HomeGraph.MainWeatherInfo -> RootTransitionProviders.Enter.pushLeft
 ...
 */
@Suppress("MaxLineLength")
fun AnimatedContentTransitionScope<NavBackStackEntry>.toExitTransition(): NonNullExitTransitionProvider =
    when (initialState.destination.rootLevelRoute()?.toAppRoute()) {
        AppRoute.SelectCityGraph -> RootTransitionProviders.Exit.stay
        AppRoute.SelectCityGraph.SelectLocationIntro -> RootTransitionProviders.Exit.stay
        AppRoute.SelectCityGraph.CityLocator -> RootTransitionProviders.Exit.slideDown
        AppRoute.Splash -> RootTransitionProviders.Exit.stay
        AppRoute.HomeGraph -> RootTransitionProviders.Exit.stay
